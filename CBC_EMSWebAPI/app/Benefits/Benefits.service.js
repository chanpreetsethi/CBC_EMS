...
var BenefitsService = (function () {
    function BenefitsService(http) {
        this.http = http;
        this.benefitsUrl = 'app/heroes'; // URL to web API
    }
    BenefitsService.prototype.getBenefits = function () {
        return this.http.get(this.benefitsUrl)
            .map(this.extractData)
            .catch(this.handleError);
    };
    BenefitsService.prototype.extractData = function (res) {
        var body = res.json();
        return body.data || {};
    };
    BenefitsService.prototype.handleError = function (error) {
